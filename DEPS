...
vars = {
  ...
  'skia_revision': 'f44d7db6880544566100ea50805fd7bcddfa0f4e',
  ...
  'dart_revision': 'cab90aac8a41f23e27a773603167384842e22bae',
  ...
  'dart_perfetto_rev': '49c59636465f2a32f4d83cff835538ba7bf8d732',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/native':
   Var('dart_git') + '/native.git@7d68fee0390f3b4d569cf9b0eec6583da04fab74',
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@88eafe209d92fe6dce7cc0239f4d4b249f63c59a',
     ...
     'packages': [
       {
        ...
        'version': 'XI0Ax7fbtYE4XKYAQKanAGX1z5dmOp9XvBJOlinnZxUC'
       }
     ],
